...
// Tus datos de ejemplo están perfectos para probar
const exampleSemesters: Semester[] = [
  {
    numero: 1,
    cursos: [
      { nombre: "asdasdasdad I", notaFinal: 5.5, codigo: "MAT101", creditos: 6, intentos: 1 },
...
// --- CAMBIO AQUÍ ---
// Renombramos la función de "HomeScreen" a "Malla"
function Malla() {
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      <Sidebar />
      <div style={{ flex: 1 }}>
        {/* Esto mostrará la malla con los datos de ejemplo */}
...
// --- CAMBIO AQUÍ ---
// Exportamos "Malla" como default, que coincide con el 'import' en App.tsx
